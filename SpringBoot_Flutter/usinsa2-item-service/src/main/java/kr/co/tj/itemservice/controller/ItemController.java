...
import kr.co.tj.itemservice.dto.NewOrder2DTO;
...
//   @PutMapping("/item/productid3")
//   public ResponseEntity<?> updateStockByProductId3(@RequestBody NewOrder2DTO newOrder2DTO) {
//
//      ItemDTO itemDTO = itemService.findById(newOrder2DTO.getId());
...
//      }
//
//      if (itemEntity.getEa() < newOrder2DTO.getOrderItems()) {
